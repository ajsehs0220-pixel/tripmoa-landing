...
const MOCK_ITINERARY = {
  ...
  sections: [
    ...
    },
    {
      ...
      title: "2일차 — 유니버설 스튜디오",
      content:
        "연인 여행이면 USJ를 하루 통째로 비우는 걸 추천하는 후기가 많았어요. 닌텐도 월드는 별도 입장권(타이밍 티켓)이 필요하니 아침 일찍 입장하는 게 좋아요 [ref:1].",
      table: null,
    },
    {
      icon: "⛩️",
  ...
  places: [
    { day: 1, name: "도톤보리", lat: 34.6687, lng: 135.5013, photo_url: "https://placehold.co/400x300?text=Dotonbori", description: "타코야키·오코노미야키 맛집 거리" },
    { day: 2, name: "유니버설 스튜디오 재팬", lat: 34.6654, lng: 135.4323, photo_url: "https://placehold.co/400x300?text=USJ", description: "닌텐도 월드 별도 입장권 필요" },
    { day: 3, name: "후시미이나리 신사", lat: 34.9671, lng: 135.7727, photo_url: "https://placehold.co/400x300?text=Fushimi+Inari", description: "사진 명소로 인기" },
  ],
...
const MOCK_LODGING = {
  ...
  warning: [],
  places: [
    { day: null, name: "난바 일대", lat: 34.6659, lng: 135.5009, photo_url: "https://placehold.co/400x300?text=Namba", description: "도톤보리 도보권, 공항 직결" },
    { day: null, name: "우메다 일대", lat: 34.7055, lng: 135.4983, photo_url: "https://placehold.co/400x300?text=Umeda", description: "교통 허브, 비즈니스호텔 밀집" },
    { day: null, name: "신사이바시 일대", lat: 34.6724, lng: 135.5007, photo_url: "https://placehold.co/400x300?text=Shinsaibashi", description: "쇼핑 중심, 야간 안전" },
  ],
